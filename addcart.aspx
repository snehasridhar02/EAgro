<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="addcart.aspx.cs" Inherits="eagro.addcart" %>
...
&nbsp;Products in your cart&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/viewcustomer1.aspx" Font-Bold="true">Continue Shopping</asp:HyperLink>
    </p>
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowFooter="True" Width="109px" OnRowDeleting="GridView1_RowDeleting" Height="213px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <Columns>
...
<ControlStyle Font-Bold="True"></ControlStyle>
    ...
    <div align="center">
    <asp:Button ID="Button1" runat="server" Text="Placeorder" OnClick="Button1_Click" BackColor="Lime" />
</div>
</asp:Content>
