        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (imageupload.HasFile)
                {
                    ...
                    SqlCommand cmd = new SqlCommand("Insert into adminadd2 values('" + TextBox1.Text + "','" + txtname.Text + "','" + txtdesc.Text + "','" + imageupload.FileName + "','" + txtprice.Text + "','" + txtquantity.Text + "')", con);
                    cmd.ExecuteNonQuery();
                    con.Close();
