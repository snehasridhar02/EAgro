...
namespace eagro
{
    public partial class placeorder : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    if (Session["buyitems"] == null)
                    {
                        ...
                        String myquery = "select * from product2 where id=" + Request.QueryString["id"];
        ...
        public void saveaddress()
        {
            ...
            s.Open();
            SqlCommand cmd1 = new SqlCommand("insert into orderaddress(orderid,name,address,mobilenumber)values('" + Label2.Text + "','" + TextBox3.Text + "','" + TextBox1.Text + "','" + TextBox2.Text + "')", s);
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from Customer1 where id='" + Session["id"].ToString()+ " ';",con);
