<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="fpay.aspx.cs" Inherits="eagro.fpay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
      <table  align="center" style="margin-top:5px;width:553px; height:696px;" bgcolor="pink">
          ...
          <tr>
              <td colspan="2" >
 <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" NavigateUrl="~/homepage.aspx" ForeColor="Black">previous Page</asp:HyperLink>
              </td>
          </tr>
      </table>
      <br />
     ...
     <div align="center">
        <a href="feedback2.aspx">Feed back us</a>
    </div>
</asp:Content>
