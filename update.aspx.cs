    ...
    public partial class update : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            if (fu.HasFile)
            {
                ...
                TextBox farmername = GridView1.Rows[e.RowIndex].FindControl("TextBox1") as TextBox;
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("Update product2 set farmername=@1,email=@2,productname=@3,pdesc=@4,image=@5,pprice=@6,pquantity=@7 where id=@8", con);
                cmd.Parameters.AddWithValue("@1", farmername.Text);
