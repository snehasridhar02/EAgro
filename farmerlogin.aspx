<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="farmerlogin.aspx.cs" Inherits="eagro.farmerlogin" %>
                    ...
                    <div class="card-body">
                           <div class="row">
                            <div class="col">
                                ...
                                <center>
                                    <img width="150" src="images/farm.jpg"/>
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Farmer ID"></asp:TextBox>
