<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="buyfertilizer.aspx.cs" Inherits="eagro.buyfertilizer" %>
        ...
        <div class="row">
          ...
          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" HorizontalAlign="Center" ForeColor="#333333" GridLines="None">
              ...
              <Columns>
                   ...
                   <asp:BoundField DataField="fname" HeaderText="Fertilizer Name" />
